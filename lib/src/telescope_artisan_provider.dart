  ...
  List<McpToolDescriptor> mcpTools() => const <McpToolDescriptor>[
        McpToolDescriptor(
          ...
          description: 'Return recent log records from the running Flutter '
              ...
              '- Returned oldest-first (last entry is newest); pair with telescope_clear before a '
        ...
        McpToolDescriptor(
          ...
          description: 'Return recent HTTP request records from the '
              ...
              '- Returned oldest-first (last entry is newest); pair with telescope_clear to '
        ...
        McpToolDescriptor(
          ...
          description: 'Clear every Telescope ring buffer in one call.\n'
              ...
              'models, frame perf) so the next telescope_* read returns only '
              'records '
        ...
        McpToolDescriptor(
          ...
          description: 'Return recent Gate authorization check records from '
              ...
              '- Pass `limit: <n>` to cap how many records come back '
              '(default returns the whole buffer).\n'
              '- Returned oldest-first (last entry is newest); pair with telescope_clear before '
